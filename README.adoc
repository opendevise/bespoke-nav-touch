...
threshold _(type: number, default: Math.ceil(20 / window.devicePixelRatio))_::
...
This fork does not interfere with scrolling, has working tests, provides a cleanup routine and is more clearly named.
